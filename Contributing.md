...
* Signaler les bogues de documentation [GitHub problèmes.](https://github.com/OfficeDev/office-scripts-docs/issues)
* Demandez une nouvelle documentation avec [GitHub problèmes.](https://github.com/OfficeDev/office-scripts-docs/issues)
...
### <a name="to-contribute-using-github"></a>Pour contribuer à l’aide GitHub
...
**Remarque**: la plupart des informations de cette section sont disponibles dans [GitHub’aide.]  Si vous êtes familiarisé avec Git et GitHub, passez à la **section** Contribuer et modifiez le contenu pour les spécificités du flux de code/contenu de ce référentiel.
...
Par exemple, si votre branche locale X a été fusionnée avec succès dans la branche maître OfficeDev/office-scripts-docs et que vous souhaitez apporter des mises à jour supplémentaires au contenu qui a été fusionné. Créez une branche locale, X2, à partir de la branche maître OfficeDev/office-scripts-docs. Pour ce faire, ouvrez GitBash et exécutez les commandes suivantes :
