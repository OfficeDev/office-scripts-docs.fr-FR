...
* Demandez une nouvelle documentation sur le site [Excel pour le site Web UserVoice](https://excel.uservoice.com/forums/274580-excel-for-the-web?category_id=143439) .
...
Par exemple, si votre branche locale X a été correctement fusionnée avec la branche principale OfficeDev/Office-scripts-docs et que vous souhaitez effectuer d’autres mises à jour du contenu qui a été fusionné. Créez une nouvelle branche locale, x2, à partir de la branche principale OfficeDev/Office-scripts-docs. Pour ce faire, ouvrez GitBash et exécutez les commandes suivantes :
