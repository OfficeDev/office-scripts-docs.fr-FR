...
quet-websocket 0.11.3 - Apache-2.0 https://github.com/faye/faye-websocket-node
...
Sauf condition requise par la loi applicable ou accepté par écrit, les logiciels distribués sous la licence sont distribués en L’état, sans GARANTIES NI CONDITIONS DE QUELQUE TYPE que ce soit, expressément ou implicitement. Consultez la licence pour la langue spécifique qui régit les autorisations et les limitations dans le cadre de la licence.
...
Vous devez donner à d’autres destinataires de la licence Work ou Derivative Works une copie de cette licence . et

Les fichiers modifiés doivent porter des notifications importantes indiquant que vous avez modifié les fichiers . et
...
Copyright (c) 2015, Guy Motte

Copyright (c) 2015, Copyright Motte All reserved.
...
Copyright (c) 2016, Guy Motte

Copyright (c) 2016, Copyright Motte All reserved.
...
Copyright (c) 2014 Copyright <ifaaan@gmail.com> (c) 2013 Yusuke Copyright <utatane.tea@gmail.com> (c) 2013-2014 Yusuke Copyright <utatane.tea@gmail.com> (c) 2013 Yusuke Copyright (c) 2013 Yusuke You (http://github.com/Constellation)
...
Copyright (c) 2013, Nick Domaine

Copyright (c) <year> <owner> . Tous droits réservés.

La redistribution et l’utilisation dans les formulaires sources et binaires, avec ou sans modification, sont autorisées à condition que les conditions suivantes soient remplies :

   1. Les redistributions du code source doivent conserver la notification de copyright ci-dessus, cette liste de conditions et la clause d’exclusion de responsabilité suivante.
...
* Ni le nom de filesize ni le nom de ses collaborateurs ne peuvent être utilisés pour approuver ou promouvoir des produits dérivés de ce logiciel sans autorisation écrite préalable spécifique.
...
<a name="software-license-agreement-bsd-license"></a>Contrat de licence logiciel (licence BSD)
========================================

<a name="copyright-c-2015-yahoo-inc-all-rights-reserved"></a>Copyright (c) 2015, Yahoo! Inc. Tous droits réservés.
----------------------------------------------------

La redistribution et l’utilisation de ce logiciel dans les formulaires sources et binaires, avec ou sans modification, sont autorisées à condition que les conditions suivantes soient remplies :

  * Les redistributions du code source doivent conserver la notification de copyright ci-dessus, cette liste de conditions et la clause d’exclusion de responsabilité suivante.
  * Les redistributions sous forme binaire doivent reproduire la notification de copyright ci-dessus, cette liste de conditions et la clause d’exclusion de responsabilité suivante dans la documentation et/ou d’autres documents fournis avec la distribution.
  * Ni le nom de Yahoo! Inc. ni les noms des collaborateurs YUI peuvent être utilisés pour approuver ou promouvoir des produits dérivés de ce logiciel sans autorisation écrite préalable spécifique de Yahoo! Inc.

CE LOGICIEL EST FOURNI PAR LES TITULAIRES DE DROITS D’AUTEUR ET LES COLLABORATEURS « EN L’ÉTAT », AINSI QUE TOUTE GARANTIE EXPRESS OU IMPLICITE, Y COMPRIS, MAIS SANS S’Y LIMITER, LES GARANTIES IMPLICITES DE QUALITÉ ET D’APTITUDE À UN USAGE PARTICULIER SONT DISCLAIMED. EN AUCUN CAS, LE PROPRIÉTAIRE OU LES COLLABORATEURS DU DROIT D’AUTEUR NE SONT RESPONSABLES DES DOMMAGES DIRECTS, INDIRECTS, INCIDENTS, SPÉCIAUX, PARTICULIERS OU INDIRECTS (Y COMPRIS, MAIS SANS S’Y LIMITER, DE L’ACHAT DE BIENS OU DE SERVICES DE SUBSTITUTION ; PERTE D’UTILISATION, DE DONNÉES OU DE BÉNÉFICES ; OU INTERRUPTION DE L’ENTREPRISE) TOUTEFOIS PROVOQUÉE ET SUR TOUTE THÉORIE DE RESPONSABILITÉ, QUE CE SOIT EN MATIÈRE DE CONTRAT, DE RESPONSABILITÉ STRICTE OU DE DÉLIT (Y COMPRIS DE NÉGLIGENCE OU AUTRE) RÉSULTANT DE QUELQUE MANIÈRE QUE CE SOIT D’UTILISER CE LOGICIEL, MÊME SI ELLE EST INFORMÉE DE LA POSSIBILITÉ DE TELS DOMMAGES.
...
* Ni les noms de Mozilla Foundation ni les noms des collaborateurs de projet ne peuvent être utilisés pour approuver ou promouvoir des produits dérivés de ce logiciel sans autorisation écrite préalable spécifique.
...
Creative Commons Corporation (« Creative Commons ») n’est pas un cabinet d’avocats et ne fournit pas de services juridiques ni de conseils juridiques. La distribution de licences publiques Creative Commons ne crée pas de relation client-avocat ou autre. Creative Commons met ses licences et les informations connexes à disposition « en l’l’espace ». Creative Commons n’offre aucune garantie concernant ses licences, tout document sous licence dans ses conditions générales ou toute information connexe. Creative Commons se dé décharge de toutes les responsabilités pour les dommages résultant de leur utilisation dans la mesure du possible.

Utilisation de licences publiques Creative Commons

Les licences publiques Creative Commons fournissent un ensemble standard de conditions générales que les créateurs et autres titulaires de droits peuvent utiliser pour partager des œuvres d’origine de la création et d’autres documents soumis à des droits d’auteur et certains autres droits spécifiés dans la licence publique ci-dessous. Les considérations suivantes sont uniquement à des fins d’information, ne sont pas exhaustives et ne font pas partie de nos licences.
...
Section 1 : Définitions.
  ...
  h. Le concédant signifie le ou les individus ou entités qui accordent des droits dans le cadre de cette licence publique.

  i. Partager signifie fournir du contenu au public par tout moyen ou processus nécessitant une autorisation dans le cadre des droits sous licence, tels que la reproduction, l’affichage public, les performances publiques, la distribution, la diffusion, la communication ou l’importation, et pour rendre le contenu accessible au public, y compris de la manière dont les membres du public peuvent accéder au matériel à partir d’un lieu et à un moment choisi individuellement par eux.

  j. Les droits de base de données Sui Generis désignent des droits autres que les droits d’auteur résultant de la directive 96/9/CE du Droit européen et du Conseil du 11 mars 1996 sur la protection juridique des bases de données, tels que modifiés et/ou qui ont réussi, ainsi que d’autres droits essentiellement équivalents n’importe où dans le monde.

  k. Vous signifiez que la personne ou l’entité qui exerce les droits sous licence dans le cadre de cette licence publique. Votre a une signification correspondante.
...
Section 5 : clause d’exclusion de garanties et limitation de responsabilité.
  ...
  b. DANS LA MESURE DU POSSIBLE, EN AUCUN CAS LE CONCÉDANT NE VOUS SERA RESPONSABLE DE TOUTE LOI JURIDIQUE (Y COMPRIS, SANS LIMITATION, NÉGLIGENCE) OU POUR TOUT AUTRE TYPE DIRECT, SPÉCIAL, INDIRECT, INCIDENTAL, INDIRECT, MATÉRIEL, MATÉRIEL OU AUTRES PERTES, COÛTS, DÉPENSES OU DOMMAGES RÉSULTANT DE CETTE LICENCE PUBLIQUE OU DE L’UTILISATION DU MATÉRIEL SOUS LICENCE, MÊME SI LE CONCÉDANT A ÉTÉ INFORMÉ DE LA POSSIBILITÉ DE TELLES PERTES,  COÛTS, DÉPENSES OU DOMMAGES. LORSQU’UNE LIMITATION DE RESPONSABILITÉ N’EST PAS AUTORISÉE EN TOTALITÉ OU EN PARTIE, CETTE LIMITATION PEUT NE PAS VOUS ÊTRE APPLICABLE.

  c. La clause d’exclusion de garanties et la limitation de responsabilité fournies ci-dessus doivent être interprétées de la manière la plus proche possible d’une clause d’exclusion de responsabilité absolue et d’une renonciation à toute responsabilité.


Section 6 :- Terme et résiliation.

  a. Cette licence publique s’applique au terme des droits d’auteur et droits similaires qui y sont titulaires. Toutefois, si vous ne vous conformez pas à cette licence publique, vos droits sous cette licence publique s’arrêtent automatiquement.

  b. Lorsque votre droit d’utiliser le matériel sous licence s’est terminé en vertu de la section 6(a), il rétablit :
  ...
  c. Pour éviter tout doute, le licenseur peut également proposer le matériel sous licence dans des conditions distinctes ou arrêter la distribution du matériel sous licence à tout moment . Toutefois, cette utilisation ne met pas fin à cette licence publique.

  d. Les sections 1, 5, 6, 7 et 8 survit à la résiliation de cette licence publique.


Section 7 :- Autres conditions générales.

  a. Le concédant ne doit pas être lié par des conditions ou conditions supplémentaires ou différentes communiquées par vous, sauf accord expressément donné.

  b. Les accords, accords ou accords concernant le matériel sous licence qui ne sont pas indiqués ici sont distincts et indépendants des termes et conditions de cette licence publique.


Section 8 -- Interprétation.

  a. À des fins de doute, cette licence publique n’est et ne doit pas être interprétée de manière à réduire, limiter, restreindre ou imposer des conditions sur toute utilisation du matériel sous licence qui pourrait être légalement réalisée sans autorisation dans le cadre de cette licence publique.

  b. Dans la mesure du possible, si une disposition de cette licence publique est considérée comme non appliquée, elle doit être automatiquement reformée dans la mesure du possible pour la rendre inapplicable. Si la disposition ne peut pas être reformée, elle sera mise à jour de la licence publique sans que cela n’affecte l’application des conditions générales restantes.

  c. Aucun terme ou condition de cette licence publique ne sera annulé et aucun échec ne sera accepté, sauf accord expressément donné par le concédant du licence.

  d. Rien dans cette licence publique ne constitue ou ne peut être interprété comme une limitation ou une renonciation à tout privilège et immunité qui s’applique au licenseur ou à vous, y compris à partir des processus juridiques d’une juridiction ou d’une autorité.


=======================================================================

Creative Commons n’est pas partie à ses licences publiques. Nonobstant, Creative Commons peut être en droit d’appliquer l’une de ses licences publiques au matériel qu’elle publie et, dans ces cas-là, elle sera considérée comme le « licenseur ». Le texte des licences publiques Creative Commons est dédié au domaine public sous le domaine public cc0 Domaine. À l’exception de l’objectif limité d’indiquer que du contenu est partagé sous une licence publique Creative Commons ou comme autrement autorisé par les stratégies Creative Commons publiées sur creativecommons.org/policies, Creative Commons n’autorise pas l’utilisation de la marque « Creative Commons » ou de toute autre marque ou logo de Creative Commons sans son consentement écrit préalable, y compris,  sans limitation, en relation avec des modifications non autorisées apportées à l’une de ses licences publiques ou à toute autre disposition, accords ou accords concernant l’utilisation de documents sous licence. Pour éviter tout doute, ce paragraphe ne fait pas partie des licences publiques.

Creative Commons peut être contacté à l’creativecommons.org.
...
Copyright (c) 2014 Elan Copyrighter

Licence ISC

Copyright (c) 2014 Elan Copyrighter

L’autorisation d’utiliser, de copier, de modifier et/ou de distribuer ce logiciel dans n’importe quel but avec ou sans frais est accordée, à condition que la notification de copyright ci-dessus et cette notification d’autorisation apparaissent dans toutes les copies.
...
Copyright (c) 2015, Ilya Rad copyright (c) <ilya@burstcreations.com>
...
Copyright (c) 2017, Jakob Domaineguel
...
to-chromium 1.3.464 - ISC https://github.com/kilian/electron-to-chromium#readme

Copyright 2018 Valkévrier
...
Copyright (c) Copyright Z.Queueter et Contributors
...
Logo de Glob créé par ContrôleSi , sous licence <http://tanyabrassie.com/> Creative Commons Attribution-ShareAlike 4.0 International License https://creativecommons.org/licenses/by-sa/4.0/
...
Copyright (c) 2015 Elan Copyrighter
...
Copyright (c) Importe Z. Copyrightueter, Ben Noordières et Contributors
...
Copyright (c) Copyright Z.Bacueter
...
hérite de 2.0.4 - ISC https://github.com/isaacs/inherits#readme
...
which 1.3.1 - ISC https://github.com/isaacs/node-which#readme
...
Copyright (c) Édition 2014 - présents à LasOY et d’autres contributeurs
...
@babel/générateur 7.10.2 - MIT https://babeljs.io/
...
Copyright (c) 2012-2014 par différents contributeurs

Copyright (C) 2012-2014 par divers contributeurs (voir AUTHORS)
...
@babel/modèle 7.10.1 - MIT https://babeljs.io/
...
Fluent Interface utilisateur React - icônes
...
@fluentui/keyboard-keys 9.0.0-alpha.3 - MIT https://github.com/microsoft/fluentui#readme

Copyright (c) Microsoft Corporation

@fluentui/touches clavier
...
Fluent Interface utilisateur React - merge-styles
...
Fluent Interface utilisateur React - Utilitaires de style
...
@fluentui/thème 1.7.4 - MIT https://github.com/microsoft/fluentui#readme
...
Fluent Interface utilisateur React - utilitaires
...
@redux-saga/différé 1.1.2 - MIT https://redux-saga.js.org/
...
@redux-saga/est 1.1.2 - MIT https://redux-saga.js.org/
...
@redux-saga/symboles 1.1.2 - MIT https://redux-saga.js.org/
...
Fluent Interface utilisateur React - stylisme
...
adresse 1.1.2 - MIT https://github.com/node-modules/address#readme
...
Copyright (c) 2016 Paul Domaine (paulmillr.com) (http://paulmillr.com)
...
postal-code-frame 6.26.0 - MIT https://babeljs.io/
...
LE LOGICIEL EST FOURNI « EN L’ÉTAT » SANS GARANTIE, EXPRESS OU IMPLICITE, Y COMPRIS, MAIS SANS S’Y LIMITER, LES GARANTIES DE QUALITÉ, D’APTITUDE À UN USAGE PARTICULIER ET NON D’INFRINGEMENT.
EN AUCUN CAS, LES AUTEURS OU LES TITULAIRES DE DROITS D’AUTEUR NE SONT RESPONSABLES DE TOUTE RÉCLAMATION, DOMMAGES OU AUTRES RESPONSABILITÉS, QUE CE SOIT DANS LE CADRE D’UNE ACTION DE CONTRAT, D’UN DÉLIT OU D’UNE AUTRE OBLIGATION, RÉSULTANT OU EN LIEN AVEC LE LOGICIEL OU L’UTILISATION OU D’AUTRES OPÉRATIONS DANS LE LOGICIEL.
...
cray 2.4.2 - MIT https://github.com/chalk/chalk#readme
...
quetet 0.7.0 - MIT https://github.com/runk/node-chardet
...
émetteur de composant 1.3.0 - MIT https://github.com/component/emitter#readme
...
6.0.5 - MIT https://github.com/moxystudio/node-cross-spawn
...
Copyright (c) 2015 Kiko Bats (c) Kiko Bats (http://www.kikobeats.com)

La licence MIT (MIT)

Copyright © 2015 Kiko Bats
...
Copyright (c) EventSource GitHub Copyright Joyent, Inc. et d’autres contributeurs Node.
...
Copyright (c) 2013 Paul Halliday Copyright (c) 2017 Evgeny Poberezkin

Ce logiciel est publié sous la licence MIT :

Copyright (c) 2017 Evgeny Poberezkin Copyright (c) 2013 Paul Halliday
...
Copyright (c) 2010-2014 Domaine Dunkel (c) 2014 par Domaine Dunkel <pip@pipobscure.com>

<a name="mit-license"></a>Licence MIT
-----------
...
historique 4.10.1 - MIT https://github.com/ReactTraining/history#readme
...
Copyright (c) 2012 Michel Boudrias Copyright (c) 2016 Copyright Boudrias (twitter vaxilart (https://twitter.com/Vaxilart))
...
Copyright (c) 2012-2018 Aseem Ki copyright, et autres
...
[autres]: https://github.com/json5/json5/contributors
...
Copyright 2012-2016, JP Copyright Copyright <jprichardson@gmail.com> (c) 2012-2015, JP Jpg <jprichardson@gmail.com>
...
type de 6.0.3 - MIT https://github.com/jonschlinkert/kind-of
...
La licence suivante s’applique à toutes les parties de ce logiciel, sauf comme documenté ci-dessous :
...
Les droits d’auteur et les droits connexes pour l’exemple de code sont annulés via CC0. L’exemple de code est défini comme tout le code source affiché dans le cadre de la documentation.
...
2.14.1 - MIT https://github.com/nodejs/nan#readme

Copyright (c) 2018 MEMBERS WG Copyright (c) 2018 CONTRIBUTORs COPYRIGHT Joyent, Inc. and other Node contributors.
Contributeurs COPYRIGHT (c) 2018 - Rod Vagg <https://github.com/rvagg>

<a name="the-mit-license-mit"></a>La licence MIT (MIT)
=====================
...
Copyright 2006, Kevin Krammer <kevin.krammer@gmx.at> Copyright 2006, Copyright White Copyright <jwhite@codeweavers.com> 2009-2010, Fathi Boudra <fabo@freedesktop.org> Copyright 2009-2010, Rex Copyright <rdieter@fedoraproject.org> (c) Sindre Sorhus <sindresorhus@gmail.com> (sindresorhus.com)
...
case 0.1.1 - MIT https://github.com/jonschlinkert/pascalcase
...
Copyright (c) Elan Copyrighter et Node.js collaborateurs.
...
Copyright (c) 2015 Domaine Blanco (c) Copyright Blanco (http://jbgutierrez.info)
...
chemin d’accès à regexp 1.8.0 - MIT https://github.com/pillarjs/path-to-regexp#readme
...
(c) Domaine d’auteur (c) Domaine d’auteur (c) <trysound@yandex.ru>

Copyright (c) ); <trysound@yandex.ru>
...
(c) 2019 Pushkarev Copyright (c) 2013-present, Facebook, Inc.
...
Copyright (c) 2013 Copyright Ly copyright 2014
...
Copyright (c) 2011 par Roly Fentanes
...
barre oblique 1.0.0 - MIT https://github.com/sindresorhus/slash
...
Copyright (c) 2019 COPYRIGHT (c) 2014, 2015, 2016, 2017, 2018, 2019 Ly prochain
...
Copyright (c) 2014 Copyright Ly copyright 2014
...
à 2.3.8 - MIT https://github.com/dominictarr/through
...
Copyright (c) 2014 ZISZI Istvan Copyright (c) 2011-2017 RADSZI Istvan <github@spam.raszi.hu>
...
Copyright (c) 2017 Piotr Copyright (c) 2017 PiotrEk <piotrek.witek@gmail.com> (http://piotrwitek.github.io)
...
Copyright (c) 2018 Hoang Van Khi

# <a name="the-mit-license"></a>Licence MIT
...
Copyright (c) 2017, Ryan Centre <opensrc@ryanzim.com>
...
utiliser 3.1.1 - MIT https://github.com/jonschlinkert/use
...
Copyright 2011, Copyright Tschan https://blueimp.net (c) 2010-2016 Robert Kieffer et d’autres collaborateurs Copyright (c) Paul Johnson 1999 - 2009 Autres contributeurs Andrew Kepert, Ydnar, Lostinet
...
valeur égale à 1.0.1 - MIT https://github.com/mjackson/value-equal#readme
