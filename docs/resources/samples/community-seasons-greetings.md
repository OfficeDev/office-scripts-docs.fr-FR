...
---
# <a name="seasons-greetings"></a>Message d’accueil de message d’accueil

Ce script a été fourni par [Megan Black](https://www.linkedin.com/in/lesblackconsultant/) lors de la période des congés ! Il s’agit d’un script amusant qui affiche une arborescence de Noël agréable dans Excel sur le web à l’aide de scripts Office.

Profitez!.

[![Regarder le script de message d’accueil de la salutation en action](../../images/community-seasons.png)](https://youtu.be/HBiGEkzmkgo "Script de message d’accueil de message d’accueil en action !")
