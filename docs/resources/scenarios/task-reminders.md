---
title: 'exemple Office scripts : rappels de tâches automatisés'
...
---
# <a name="office-scripts-sample-scenario-automated-task-reminders"></a>exemple Office scripts : rappels de tâches automatisés
...
1. Enregistrez le script sous le nom **Obtenir des personnes**.
...
1. **Sélectionnez Déclencher manuellement un flux à** partir des options, puis sélectionnez **Créer**.
...
1. Ensuite, le flux doit traiter chaque employé dans le tableau renvoyé par le script. **Sélectionnez Nouvelle étape**, puis choisissez Publier une carte **adaptative à un Teams utilisateur et attendre une réponse**.
...
1. Dans le **bloc Appliquer à chaque** bloc, après avoir publié une carte adaptative à un utilisateur **Teams** et attendre une réponse, sélectionnez Ajouter **une action**. **Sélectionnez Excel Online (Entreprise).** Sous **Actions**, sélectionnez **Exécuter le script**. Fournissez les entrées suivantes pour l’étape de flux :
